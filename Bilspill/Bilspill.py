...
Bil = pygame.image.load("BIlder til bilspill/racecar.png")
bane = pygame.image.load("BIlder til bilspill/track3_2.jpg")
rent_bilde = pygame.image.load("BIlder til bilspill/track2.png")
